...
$(document).ready(function() {
  function checkWidth() {
    ...
    if(windowWidth < 979){
      elem.addClass('owl-carousel');
      elem.addClass('flat-wr-add');
  }
  else{
      elem.removeClass('owl-carousel');
      elem.removeClass('flat-wr-add');
  }
}
...
$(document).ready(function(){
    ...
    var owlflat = $('.flat-wr-add');
    owl.owlCarousel();
    $('.NextBtn-flat').click(function() {
     owlflat.trigger('next.owl.carousel');
 })
    $('.PrevBtn-flat').click(function() {
        owlflat.trigger('prev.owl.carousel', [300]);
...
$(document).ready(function () {
    var url = document.location.toString();
    $("[href='ourflats.html']").filter(function () {
        return url.indexOf(this.href) != -1;
    }).addClass("current");
});
...
$( document ).ready(function() {
    $(".flat-item__link").click(function() {        
        $('.openplan').addClass("opennews-active");
    })
});
$( document ).ready(function() {
    $(".openplan1__close-btn").click(function() {        
        $('.openplan').removeClass("opennews-active");
    })
});
